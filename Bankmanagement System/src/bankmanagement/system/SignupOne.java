...
public class SignupOne  extends JFrame implements ActionListener{
        ...
        SignupOne(){
            ...
            JLabel PersonalDetails = new JLabel("Pagr 1: Personal Details");
            ...
            addressTextField.setFont(new Font("Raieway",Font.BOLD,13));
            ...
            cityTextField.setFont(new Font("Raieway",Font.BOLD,13));
            ...
            add(stateTextField);
             ...
             pincodeTextField.setFont(new Font("Raieway",Font.BOLD,13));
        ...
        public void actionPerformed(ActionEvent ae){
            ...
            String name = nameTextField.getText(); //value get krne k liye
            ...
            String gender = null;
              ...
              try{
                 if(name.equals("")){
                     ...
                     setVisible(false);
                     new SignupTwo(formno).setVisible(true);  //making constructor from so=ignuptwoc class
                 }
